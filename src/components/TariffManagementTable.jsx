      ...
      <div className="card-section" style={{ padding: '1.5rem' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '1rem' }}>
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <h2 className="card-title" style={{ fontSize: '1.3rem' }}>
                Master Tarif Transportasi & Biaya Lokasi
              </h2>
            </div>
            <div className="card-subtitle" style={{ marginTop: '0.25rem' }}>
              8. CABANG MADYA KLAS PONTIANAK • Standar Biaya Transport Dalam Tugas Surveyor
            </div>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            ...
            >
              <ShieldCheck size={14} />
              <span>Akses Khusus: {role === 'admin' ? 'Admin Utama' : role === 'kacab' ? 'Kepala Cabang' : 'Finance / Keuangan'}</span>
            </span>
          </div>
        </div>
